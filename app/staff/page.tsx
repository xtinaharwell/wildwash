                      ...
                      {profile?.role === 'washer' ? (
                        ...
                        o.status !== 'ready' && (
                          <button
                            ...
                            className="px-3 py-1 rounded-lg bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 hover:bg-purple-200 dark:hover:bg-purple-900/50 text-xs font-medium transition-colors shadow-sm hover:shadow-md"
                          >
                            Mark as Ready
                          </button>
                        )
